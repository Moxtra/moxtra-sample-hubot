...
#   mbmccormick
env = process.env
key = '5fb3db8c42d0b609be72f737862abd74'
forecastIoUrl = 'https://api.forecast.io/forecast/' + key + '/'
...
lookupWeather = (msg, coords, err) ->
  ...
  return msg.send "You need to set env.HUBOT_FORECAST_API_KEY to get weather data" if not key
